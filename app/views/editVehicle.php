...
<body>
    <main class="container border border-top-0 px-0">
        <header class="d-flex align-items-center justify-content-between bg-primary bg-gradient px-4 py-3">
            <h1 class="h4 text-white">Editar veículo</h1>
        </header>
        <form
            <?php echo "action='/vehicles/{$id}/edit'" ?>
            method='post' class='needs-validation p-4' novalidate>
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="text" class="form-control" id="ownerName" name="ownerName" placeholder="Ex.: João da Silva" required
                        <?php echo "value={$vehicle->owner_name}" ?>
                    >
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <select class='form-select' id='colorId' name='colorId' required>
                        ...
                        <?php
                            $selectedId = $vehicle->color_id;

                            foreach ($colors as $color) {
                                echo $color->id == $selectedId
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="plate" name="plate" placeholder="Ex.: AAA0000" required
                           maxlength="7"
                           pattern="^[A-Z]{3}-?\d{4}$|^[A-Z]{3}\d[A-Z]\d{2}$"
                        <?php echo "value={$vehicle->plate}" ?>
                    >
                    <div class="invalid-feedback">
